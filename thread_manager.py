...
from resorts_data import get_Resorts_data  # استيراد دالة بيانات المنتجعات
    ...
    def run_assistant(self, assistant_id, instructions):
        if self.thread:
            ...
            for tool in run.required_action.submit_tool_outputs.tool_calls:
                ...
                if tool.function.name == "get_Resorts_data":
                    output = get_Resorts_data(resortId=arguments["resortId"])
                    print(f"Fetched Resort Data: {output}")
